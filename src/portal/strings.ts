...
const es = {
  ...
  noProgressMedia: 'Cuando el taller comparta novedades del trabajo, aparecerán aquí.',
...
const en: PortalStrings = {
  ...
  noProgressMedia: 'Updates about the work will appear here when the shop shares them.',
